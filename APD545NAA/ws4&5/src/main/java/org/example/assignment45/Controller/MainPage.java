...
import org.example.assignment45.Model.*;
...
public class MainPage {
    ...
    public void initialize() {
        ...
        Part part1 = new InHouse(1, "Bolt", 0.25, 100, 10, 500, 101);
        Part part2 = new InHouse(2, "Nut", 0.15, 150, 20, 600, 102);
        Part part3 = new InHouse(3, "Screw", 0.10, 200, 30, 700, 103);
        Part part4 = new Outsourced(4, "Wheel", 15.99, 20, 5, 50, "WheelWorks");
        Part part5 = new Outsourced(5, "Seat", 25.50, 15, 3, 40, "SeatsRUs");

        Product product1 = new Product(1, "Bicycle", 299.99, 5, 1, 10);
        Product product2 = new Product(2, "Scooter", 199.99, 8, 2, 15);
        Product product3 = new Product(3, "Skateboard", 99.99, 12, 5, 20);
        Product product4 = new Product(4, "Helmet", 49.99, 25, 10, 50);
        Product product5 = new Product(5, "Rollerblades", 149.99, 7, 3, 12);
    ...
    void onAddPart(ActionEvent event) throws IOException {
        openWindow("/org/example/assignment45/add-part.fxml", "Add Part");
    }
    ...
    void onModifyPart(ActionEvent event) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/org/example/assignment45/modify-part.fxml"));
    ...
    void onAddProduct(ActionEvent event) throws IOException {
        openWindow("/org/example/assignment45/add-product.fxml", "Add Product");
    }
    ...
    void onModifyProduct(ActionEvent event) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/org/example/assignment45/modify-product.fxml"));
        Parent root = loader.load();
